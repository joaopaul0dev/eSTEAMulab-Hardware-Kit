<div align="center">
  ...
  **O seu ponto de partida para prototipagem rápida e Internet das Coisas (IoT).**
  ...
  [![Code Style Linter](https://img.shields.io/github/actions/workflow/status/joaopaul0dev/eSTEAMulab-Hardware-Kit/clang-format.yml?style=flat-square&logo=github&label=Code%20Style)](https://github.com/joaopaul0dev/eSTEAMulab-Hardware-Kit/actions/workflows/clang-format.yml)
</div>
...
| Componente | Função Principal | Massa de Teste | Acesso Rápido |
| :--- | :--- | :---: | :--- |
| **Web Server** | Controlar o ESP32 pelo navegador do telemóvel | 🔴 | [📁 `/08-esp32-webserver`](./08-esp32-webserver/) |
